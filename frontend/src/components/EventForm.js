    ...
    <Form method={method} className={classes.form}>
      ...
      <p>
        ...
        <input
          ...
          name="title"
          required
          defaultValue={event && event.title ? event.title : ""}
        />
      </p>
      <p>
        ...
        <input
          ...
          name="image"
          required
          defaultValue={event && event.image ? event.image : ""}
        />
      </p>
      <p>
        ...
        <input
          ...
          name="date"
          required
          defaultValue={event && event.date ? event.date : ""}
        />
      </p>
      <p>
        ...
        <textarea
          ...
          rows="5"
          required
          defaultValue={event && event.description ? event.description : ""}
        />
      </p>
